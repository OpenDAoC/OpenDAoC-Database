...
) ENGINE=InnoDB AUTO_INCREMENT=3352 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
REPLACE INTO `specxability` (`SpecXAbility_ID`, `Spec`, `SpecLevel`, `AbilityKey`, `AbilityLevel`, `SpecXabilityID`, `ClassId`, `LastTimeRowUpdated`) VALUES
	...
	('', 'HunterCareer', 20, 'Evade', 3, 216, 0, '2000-01-01 00:00:00'),
	...
	('', 'ArmsmanCareer', 50, 'Climb Walls', 0, 500, 0, '2000-01-01 00:00:00'),
	('', 'HeroCareer', 50, 'Climb Walls', 0, 501, 0, '2000-01-01 00:00:00'),
	('', 'WarriorCareer', 50, 'Climb Walls', 0, 502, 0, '2000-01-01 00:00:00'),
	...
	('', 'Crossbows', 25, 'Snapshot', 1, 3350, 0, '2000-01-01 00:00:00');
