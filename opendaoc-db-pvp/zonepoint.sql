...
REPLACE INTO `zonepoint` (`Id`, `TargetX`, `TargetY`, `TargetZ`, `TargetRegion`, `TargetHeading`, `SourceX`, `SourceY`, `SourceZ`, `SourceRegion`, `Realm`, `ClassType`, `LastTimeRowUpdated`, `ZonePoint_ID`) VALUES
	...
	(81, 31211, 27924, 22893, 249, 3072, 599716, 536189, 2960, 1, 1, 'Core.GS.Server.DfEnterJumpPoint', '2023-10-24 00:00:00', 'ALB DF ENTRANCE ALB'),
	(81, 31211, 27924, 22893, 249, 3072, 599708, 536194, 2960, 1, 3, 'Core.GS.Server.DfEnterJumpPoint', '2023-10-24 00:00:00', 'ALB DF ENTRANCE HIB'),
	(81, 31211, 27924, 22893, 249, 3072, 599745, 536184, 2960, 1, 2, 'Core.GS.Server.DfEnterJumpPoint', '2023-10-24 00:00:00', 'ALB DF ENTRANCE MID'),
	...
	(79, 30550, 27898, 22893, 249, 3065, 601798, 430727, 5856, 1, 1, 'Core.GS.Server.DfEnterJumpPoint', '2023-10-24 00:00:00', 'DF ENTRANCE ALB RELIC 1'),
	(87, 46325, 40969, 21357, 249, 2045, 325269, 433985, 6297, 200, 0, 'Core.GS.Server.DfEnterJumpPoint', '2023-10-24 00:00:00', 'DF Entrance HIB'),
	(84, 18798, 18667, 22892, 249, 1022, 760580, 700467, 6328, 100, 1, 'Core.GS.Server.DfEnterJumpPoint', '2023-10-24 00:00:00', 'DF ENTRANCE MID ALB'),
	(84, 18798, 18667, 22892, 249, 1022, 760606, 700489, 6321, 100, 3, 'Core.GS.Server.DfEnterJumpPoint', '2023-10-24 00:00:00', 'DF ENTRANCE MID HIB'),
	(84, 18798, 18667, 22892, 249, 1022, 760600, 700475, 6340, 100, 2, 'Core.GS.Server.DfEnterJumpPoint', '2023-10-24 00:00:00', 'DF ENTRANCE MID MID'),
	(82, 18798, 18667, 22892, 249, 1022, 771939, 626406, 7184, 100, 2, 'Core.GS.Server.DfEnterJumpPoint', '2023-10-24 00:00:00', 'DF ENTRANCE MID RELIC 1'),
	(83, 18798, 18667, 22892, 249, 1022, 676906, 710798, 7104, 100, 2, 'Core.GS.Server.DfEnterJumpPoint', '2023-10-24 00:00:00', 'DF ENTRANCE MID RELIC 2'),
	...
	(85, 46325, 40969, 21357, 249, 2045, 400771, 465841, 3080, 200, 3, 'Core.GS.Server.DfEnterJumpPoint', '2023-10-24 00:00:00', 'DUN DAGDA DF ENTRANCE'),
	(86, 46325, 40969, 21357, 249, 2045, 348776, 373379, 5071, 200, 3, 'Core.GS.Server.DfEnterJumpPoint', '2023-10-24 00:00:00', 'DUN LAMFHOTA DF ENTRANCE'),
